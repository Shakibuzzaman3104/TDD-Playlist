...
class PlaylistFeature {
    ...
    // To tell our test to target MainActivity
    val maActivityRule = ActivityScenarioRule(MainActivity::class.java)
        @Rule get
    ...
    //To test RecyclerView children we need this utility method
